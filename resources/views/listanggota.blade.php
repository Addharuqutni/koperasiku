      ...
      <div class="">
          <div class="box box-primary">
            <!-- form start -->
              ...
              <form action="/anggota/show" method="post">
                <div class="form-group">
                  <label >No Anggota</label>
                  <p class="form-control">{{ $a->id_anggota }}
                </div>
                <div class="form-group">
                  <label >Nama</label>
                  <p class="form-control">{{ $a->nama }}
                </div>
                <div class="form-group">
                  <label >Alamat</label>
                  <p class="form-control">{{ $a->alamat }}
                </div>
                <div class="form-group">
                  <label>Jenis Kelamin</label>
                  <p class="form-control">{{ $a->j_kelamin }}
                </div>
                <div class="form-group">
                  <label >No.Telphone</label>
                  <p class="form-control">{{ $a->no_telp }}
                </div>
                <div class="form-group">
                  <label >No. KTP</label>
                  <p class="form-control">{{ $a->no_ktp }}
                </div>
                <div class="form-group">
                  <label >No. Rekening</label>
                  <p class="form-control">{{ $a->no_rek }}
                </div>
                <div class="form-group">
                  <label>Tanggal Masuk dan Keluar</label>
                  <p class="form-control">{{ $a->tgl_masuk }}
                </div>
              </form>
              @endforeach               
              </div>
