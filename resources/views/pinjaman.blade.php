            ...
            {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="id_pinjaman" placeholder="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>Pinjaman</label>
                    <select name="j_pinjaman" class="form-control" date-placeholder="Jenis Pinjaman">
                      <option>Pinjaman 1</option>
                      <option>Pinjaman 2</option>
                      <option>Pinjaman Bank</option>
                    </select>
                  <!-- <input type="text" class="form-control" id="jenis_kelamin" placeholder="Masukan Jenis Kelamin"> -->
                </div>
                <div class="form-group">
                  <label>Provisi</label>
                  <input type="text" class="form-control" name="provisi" placeholder="Masukan Provisi">
                </div>        
                <div class="form-group">
                  <label>Nominal</label>
